(function($) {
	...
	function OEmbedProvider(name, urlPattern, oEmbedUrl, callbackparameter) {
		...
		this.oEmbedUrl = (oEmbedUrl != null) ? oEmbedUrl : 'http://oohembed.com/oohembed/'; // 'https://api.embed.ly/1/oembed'
		...
		this.getRequestUrl = function(externalUrl) {
			...
			url += "format=json&url=" + escape(externalUrl) + qs + "&" + this.callbackparameter + "=?";
